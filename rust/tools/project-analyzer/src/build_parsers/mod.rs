...
pub fn detect_project_type_from_files(files: &[crate::models::FileInfo]) -> (String, f64) {
...
fn has_rust_workspace(files: &[crate::models::FileInfo]) -> bool {
...
fn has_vscode_extension(files: &[crate::models::FileInfo]) -> bool {
    files.iter()
