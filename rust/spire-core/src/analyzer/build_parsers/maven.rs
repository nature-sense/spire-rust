...
pub fn parse_pom(project_root: &Path) -> Option<BuildMetadata> {
    ...
    Some(BuildMetadata {
        ...
        workspace_members,
        scripts: vec![
            BuildScript { name: "compile".to_string(), command: "mvn compile".to_string(), tool_call: Some(serde_json::json!({"tool": "project/build", "args": {"mode": "compile"}})) },
            BuildScript { name: "test".to_string(), command: "mvn test".to_string(), tool_call: Some(serde_json::json!({"tool": "project/build", "args": {"mode": "test"}})) },
            BuildScript { name: "package".to_string(), command: "mvn package".to_string(), tool_call: Some(serde_json::json!({"tool": "project/build", "args": {"mode": "package"}})) },
            BuildScript { name: "clean".to_string(), command: "mvn clean".to_string(), tool_call: Some(serde_json::json!({"tool": "project/build", "args": {"mode": "clean"}})) },
            BuildScript { name: "install".to_string(), command: "mvn install".to_string(), tool_call: Some(serde_json::json!({"tool": "project/build", "args": {"mode": "install"}})) },
        ],
        features: vec![],
        targets: vec![],
