...
cp "$ROOT/ts/spire-extension/src/webview/index.html" "$WEBVIEW_DIR/index.html"
cp "$ROOT/ts/spire-extension/src/webview/sidebar-provider.ts" "$WEBVIEW_DIR/sidebar-provider.ts"
